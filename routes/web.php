...
Route::middleware(['auth'])->group(function () {
    ...
    /*MENU REFERENCIALES*/
        ...
        //Departamentos routes
            ...
            Route::get('nota-motivos/{motivo}', 'NotaCreditoMotivoController@show')->name('nota-motivos.show')->middleware('permission:nota-motivos.show');
            Route::get('nota-motivos/{motivo}/edit', 'NotaCreditoMotivoController@edit')->name('nota-motivos.edit')->middleware('permission:nota-motivos.edit');
            Route::put('nota-motivos', 'NotaCreditoMotivoController@update')->name('nota-motivos.update');
            Route::delete('nota-motivos', 'NotaCreditoMotivoController@destroy')->name('nota-motivos.delete');
        //Departamentos routes
