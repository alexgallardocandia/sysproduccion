                        ...
                        <tr>
                          ...
                          <td>                        
                            <a href="{{url('permisos/' . $permiso->id)}}"><i class="bi bi-info-circle-fill"></i></a>                          
                              ...
                              <a data-bs-toggle="modal" data-bs-target="#permiso_delete" data-name="{{$permiso->display_name}}" data-id="{{ $permiso->id }}"><i class="bi bi-trash-fill"></i></a>                                                    
                          </td>
                        </tr>
                    @endforeach
                  </tbody>
              ...
              <div class="modal-content">
                ...
                <form method="POST" action="{{route('permisos.delete')}}">
                  ...
                  <div class="modal-body">
                    <p>Deseas eliminar el permiso <b><span id="permiso_id"></span></b>?</p>
...
<script>
  $(document).ready(function(){
    ...
    $('#permiso_delete').on('show.bs.modal', function(event) {
