          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
                <h5>Editar Pedido de Compra #{{$pedido->id}}</h5>              
              </div>
              <div class="card-body">
                <div class="mb-3"></div>
                <form class="row g-3" id="form">
                  ...
                  <div class="col-md-3">
                    ...
                    <select class="form-select" name="prioridad" id="prioridad">
                      <option value="@json($pedido->prioridad)" selected>{{ config('constants.pedidos-compras-prioridad.'.$pedido->prioridad) }}</option>
...
<script>
    ...
    $(document).ready(function() {      
        ...
        $('#btn_agregar').click(function() {
          ...
          if(materia === 'Seleccione una materia prima' || cantidad == 0|| cantidad == '' || umedida === 'Seleccione una unidad'){           
            ...
            addDetail(materianame, cantidad,umedida, materia, umedida_id);
    ...
    function addDetail(mat, cant,ume, mat_id, ume_id){
      count++;
      $('#ped_det').append(
        '<tr>'+
          '<td>'+count+'</td>'+
