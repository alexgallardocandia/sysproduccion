                                ...
                                <tbody>
                                    @foreach ($details as $detail)
                                        <tr>
                                            ...
                                            <td>
                                                <input class="form-check-input" type="checkbox" name="check_aprove[{{$detail->materia_prima_id}}]" id="check_aprove" />
                                                <input type="hidden" name="presupuesto_id" value="{{$presupuestocompra->id}}" />
                                                <input type="hidden" name="detail_id_materia[]" value="{{$detail->materia_prima_id}}" />
                                            </td>
                                        </tr>
                                    @endforeach
                                </tbody>
