          ...
          --}}
                      ...
                      <div class="col-12">
                        <div class="card">
                          ...
                          {{-- <div class="card-body">
                            <h5 class="card-title">Reporte <span><b>{{date('d/m/Y')}}</b></span></h5>
                          ...
                          <div class="card-body">
                            <h5 class="card-title">Bienvenido/a <span><b>{{auth()->user()->empleado->fullname}}</b></span></h5>
                            <h6>Excelente Jornada en <span><b>Sucursal: {{auth()->user()->empleado->sucursal->descripcion}}</b></span></h6>
